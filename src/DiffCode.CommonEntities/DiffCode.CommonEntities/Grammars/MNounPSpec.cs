...
/// <summary>
/// Грамматика для существительного мужского рода множ. спец. числа.
/// </summary>
public record MNounPSpec : BaseGrammar
{
  public MNounPSpec(string end, NOM nom, GEN gen, DAT dat, ACC acc, INS ins, LOC loc) : base(end, nom, gen, dat, acc, ins, loc)
  {
