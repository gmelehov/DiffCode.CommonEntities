...
/// <summary>
/// Грамматика для существительного мужского рода множ. числа.
/// </summary>
public record MNounP : BaseGrammar
{
  public MNounP(string end, NOM nom, GEN gen, DAT dat, ACC acc, INS ins, LOC loc) : base(end, nom, gen, dat, acc, ins, loc)
  {
