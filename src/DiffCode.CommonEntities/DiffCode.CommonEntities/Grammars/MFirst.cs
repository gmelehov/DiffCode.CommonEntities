...
/// <summary>
/// Грамматика для мужского личного имени.
/// </summary>
public record MFirst : BaseGrammar
{
  public MFirst(string end, NOM nom, GEN gen, DAT dat, ACC acc, INS ins, LOC loc) : base(end, nom, gen, dat, acc, ins, loc)
  {
