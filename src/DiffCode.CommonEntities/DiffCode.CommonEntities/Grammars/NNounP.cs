...
/// <summary>
/// Грамматика для существительного среднего рода множ. числа.
/// </summary>
public record NNounP : BaseGrammar
{
  public NNounP(string end, NOM nom, GEN gen, DAT dat, ACC acc, INS ins, LOC loc) : base(end, nom, gen, dat, acc, ins, loc)
  {
