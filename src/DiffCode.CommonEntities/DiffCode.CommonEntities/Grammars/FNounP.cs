...
/// <summary>
/// Грамматика для существительного женского рода множ. числа.
/// </summary>
public record FNounP : BaseGrammar
{
  public FNounP(string end, NOM nom, GEN gen, DAT dat, ACC acc, INS ins, LOC loc) : base(end, nom, gen, dat, acc, ins, loc)
  {
