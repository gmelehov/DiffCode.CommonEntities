...
/// <summary>
/// Грамматика для существительного женского рода множ. спец. числа.
/// </summary>
public record FNounPSpec : BaseGrammar
{
  public FNounPSpec(string end, NOM nom, GEN gen, DAT dat, ACC acc, INS ins, LOC loc) : base(end, nom, gen, dat, acc, ins, loc)
  {
